...
//    
//    //return h value between position and goal position
...
//    
//    //position is target?
//    mutating func findTarget(positioin: Self.Position) -> Bool
//}
//
////MARK: == PathFinderType ==
...
//    
//    //execute single goal
//    func execute(request: Self.Request, _ visitation: (([Self.Position: Self.Position]) -> ())?) -> [Self.Position]?
//}
